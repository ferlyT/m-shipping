...
import { Globe, Package, Navigation, Phone, MapPin, Truck, PackageSearch } from 'lucide-react-native';
...
const getStyles = (Colors: any) => StyleSheet.create({
  ...
  cardHeaderLight: { fontSize: 10, color: Colors.secondary, letterSpacing: 1, fontWeight: 'bold' },
